      ...
      <div>
        <nav className="navbar navbar-light fixed-top bg-light flex-md-nowrap p-0 shadow">
          <a
            ...
            href="https://richofftheblocks.derekwebdev.com"
            target="_blank"
        ...
        <div className="container-fluid mt-5 content">
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto text-white" style={{ width: "500px" }}>
                <a
                  href="https://richofftheblocks.derekwebdev.com"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <table className="table">
                  <thead>
                    <tr>
                      <th scope="col" className="text-white">Recipient</th>
                      <th scope="col" className="text-white">Value</th>
                    </tr>
                  </thead>
                  <tbody>
